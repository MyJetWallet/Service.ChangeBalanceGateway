...
{
    [DataContract]
    public class ManualChangeBalanceGrpcRequest
    {
        ...
        [DataMember(Order = 9)] public string Officer { get; set; }

        [DataMember(Order = 10)] public AgentInfo Agent { get; set; } = new AgentInfo();
    }
}